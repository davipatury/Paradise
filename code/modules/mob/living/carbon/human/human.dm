						...
						if(R.fields["id"] == E.fields["id"])
							if(hasHUD(usr,"security"))
								...
								if(ishuman(usr))
									...
									R.fields["comments"] = text("Made by [U.get_authentification_name()] ([U.get_assignment()]) on [current_date_string] [worldtime2text()], [game_year]<BR>[t1]")
								if(isrobot(usr))
									var/mob/living/silicon/robot/U = usr
									R.fields["comments"] = text("Made by [U.name] ([U.modtype] [U.braintype]) on [current_date_string] [worldtime2text()], [game_year]<BR>[t1]")
								if(isAI(usr))
									var/mob/living/silicon/ai/U = usr
									R.fields["comments"] = text("Made by [U.name] (artificial intelligence) on [current_date_string] [worldtime2text()], [game_year]<BR>[t1]")
					...
					for(var/datum/data/record/R in data_core.medical)
						if(R.fields["id"] == E.fields["id"])
							if(hasHUD(usr,"medical"))
								...
								if(ishuman(usr))
									var/mob/living/carbon/human/U = usr
									R.fields["comments"] = text("Made by [U.get_authentification_name()] ([U.get_assignment()]) on [current_date_string] [worldtime2text()]<BR>[t1]")
								if(isrobot(usr))
									var/mob/living/silicon/robot/U = usr
									R.fields["comments"] = text("Made by [U.name] ([U.modtype] [U.braintype]) on [current_date_string] [worldtime2text()]<BR>[t1]")
								if(isAI(usr))
									var/mob/living/silicon/ai/U = usr
									R.fields["comments"] = text("Made by [U.name] (artificial intelligence) on [current_date_string] [worldtime2text()]<BR>[t1]")
