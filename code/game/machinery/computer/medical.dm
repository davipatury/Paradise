...
/obj/machinery/computer/med_data/Topic(href, href_list)
	...
	if(authenticated)
		...
		if(href_list["del_all"])
			...
			buttons[++buttons.len] = list("name" = "Yes", "icon" = "check", "val" = "del_all2=1")
			buttons[++buttons.len] = list("name" = "No", "icon" = "times", "val" = null)
		...
		if(href_list["field"])
			...
			switch(href_list["field"])
				...
				if("p_stat")
					if(istype(active1, /datum/data/record))
						var/list/buttons = list()
						buttons[++buttons.len] = list("name" = "*Deceased*", "icon" = "stethoscope", "val" = "p_stat=deceased", "status" = (active1.fields["p_stat"] == "*Deceased*" ? "selected" : null))
						buttons[++buttons.len] = list("name" = "*SSD*", "icon" = "stethoscope", "val" = "p_stat=ssd", "status" = (active1.fields["p_stat"] == "*SSD*" ? "selected" : null))
						buttons[++buttons.len] = list("name" = "Active", "icon" = "stethoscope", "val" = "p_stat=active", "status" = (active1.fields["p_stat"] == "Active" ? "selected" : null))
						buttons[++buttons.len] = list("name" = "Physically Unfit", "icon" = "stethoscope", "val" = "p_stat=unfit", "status" = (active1.fields["p_stat"] == "Physically Unfit" ? "selected" : null))
						buttons[++buttons.len] = list("name" = "Disabled", "icon" = "stethoscope", "val" = "p_stat=disabled", "status" = (active1.fields["p_stat"] == "Disabled" ? "selected" : null))
						setTemp("<h3>Physical Condition</h3>", buttons)
				if("m_stat")
					if(istype(active1, /datum/data/record))
						var/list/buttons = list()
						buttons[++buttons.len] = list("name" = "*Insane*", "icon" = "stethoscope", "val" = "m_stat=insane", "status" = (active1.fields["m_stat"] == "*Insane*" ? "selected" : null))
						buttons[++buttons.len] = list("name" = "*Unstable*", "icon" = "stethoscope", "val" = "m_stat=unstable", "status" = (active1.fields["m_stat"] == "*Unstable*" ? "selected" : null))
						buttons[++buttons.len] = list("name" = "*Watch*", "icon" = "stethoscope", "val" = "m_stat=watch", "status" = (active1.fields["m_stat"] == "*Watch*" ? "selected" : null))
						buttons[++buttons.len] = list("name" = "Stable", "icon" = "stethoscope", "val" = "m_stat=stable", "status" = (active1.fields["m_stat"] == "Stable" ? "selected" : null))
						setTemp("<h3>Mental Condition</h3>", buttons)
				if("b_type")
					if(istype(active2, /datum/data/record))
						var/list/buttons = list()
						buttons[++buttons.len] = list("name" = "A-", "icon" = "tint", "val" = "b_type=an", "status" = (active2.fields["b_type"] == "A-" ? "selected" : null))
						buttons[++buttons.len] = list("name" = "A+", "icon" = "tint", "val" = "b_type=ap", "status" = (active2.fields["b_type"] == "A+" ? "selected" : null))
						buttons[++buttons.len] = list("name" = "B-", "icon" = "tint", "val" = "b_type=bn", "status" = (active2.fields["b_type"] == "B-" ? "selected" : null))
						buttons[++buttons.len] = list("name" = "B+", "icon" = "tint", "val" = "b_type=bp", "status" = (active2.fields["b_type"] == "B+" ? "selected" : null))
						buttons[++buttons.len] = list("name" = "AB-", "icon" = "tint", "val" = "b_type=abn", "status" = (active2.fields["b_type"] == "AB-" ? "selected" : null))
						buttons[++buttons.len] = list("name" = "AB+", "icon" = "tint", "val" = "b_type=abp", "status" = (active2.fields["b_type"] == "AB+" ? "selected" : null))
						buttons[++buttons.len] = list("name" = "O-", "icon" = "tint", "val" = "b_type=on", "status" = (active2.fields["b_type"] == "O-" ? "selected" : null))
						buttons[++buttons.len] = list("name" = "O+", "icon" = "tint", "val" = "b_type=op", "status" = (active2.fields["b_type"] == "O+" ? "selected" : null))
		...
		if(href_list["del_r"])
			if(active2)
				var/list/buttons = list()
				buttons[++buttons.len] = list("name" = "Yes", "icon" = "check", "val" = "del_r2=1", "status" = null)
